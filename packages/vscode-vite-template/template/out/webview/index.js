...
const WebView_vue_vue_type_style_index_0_lang = "";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    _ctx.show ? (openBlock(), createElementBlock("h2", _hoisted_1, "Show Text")) : createCommentVNode("", true)
  ], 64);
}
const WebView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
createApp({
  setup() {
    return {};
  },
